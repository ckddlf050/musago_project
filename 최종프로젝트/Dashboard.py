...
class RealtimePredictDashboard(QWidget):
    def __init__(self):
        ...
        self.sensor_thresholds = {
            ...
            "humidity": {"threshold": 40, "operator": "<=", "icon": "💧", "name": "습도", "unit": "%"},
        ...
        self.prediction_paths = {
            ...
            "위험 예측": os.path.join(base_path, "risk_prediction.csv"),
            "복합 위험 등급": os.path.join(base_path, "risk_level_prediction.csv"),
            "고장 예측": os.path.join(base_path, "fault_prediction.csv"),
            "에너지 예측": os.path.join(base_path, "energy_prediction.csv")
        }
    ...
    def check_data_processing(self):
        ...
        if all_predictions_done and sensor_updated and (time.time() - self.start_time >= 2):
            self.processing_data = False
